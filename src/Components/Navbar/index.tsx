  ...
  return (
    <nav className="nav__container">
      <div className="div_content">
        ...
        <a href="#" className="nav__item first">Help</a>
        <a href="#" className="nav__item first">Blog</a>
      </div>
      <div className="div_content">
        <a href="#" className="nav__item">Account</a>
        <a href="#" className="nav__item cart" onClick={props.showCart}>
          ...
          <div className="label">{props.quantityCount}</div>
        </a>
      </div>
    </nav>
  )
